...
# Assert
TARGET_OTA_ASSERT_DEVICE := babylon,2211133C,2211133G
...
# Firmware
#-include vendor/xiaomi/babylon-firmware/BoardConfigVendor.mk
...
# Init
TARGET_INIT_VENDOR_LIB := //$(DEVICE_PATH):libinit_babylon
TARGET_RECOVERY_DEVICE_MODULES := libinit_babylon
